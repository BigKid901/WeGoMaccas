...
//Carrots     |---Position---| |------Dimensions------|                                 |Where You're Sent|
carrots.push({ x: 460, y: 350, width: 020, height: 020, color: 'purple', effect: 'tele', px: 20, py: 370 });
carrots.push({ x: 665, y: 289, width: 020, height: 020, color: 'purple', effect: 'tele', px: 20, py: 370 });
carrots.push({ x: 925, y: 195, width: 020, height: 020, color: 'purple', effect: 'tele', px: 20, py: 370 });
carrots.push({ x: 760, y: 130, width: 020, height: 020, color: 'purple', effect: 'tele', px: 20, py: 370 });
carrots.push({ x: 680, y: 115, width: 020, height: 020, color: 'purple', effect: 'tele', px: 20, py: 370 });
carrots.push({ x: 030, y: 130, width: 020, height: 020, color: 'purple', effect: 'tele', px: 20, py: 370 });
carrots.push({ x: 330, y: 180, width: 020, height: 020, color: 'purple', effect: 'tele', px: 20, py: 370 });
//Lava
lava.push   ({ x: 090, y: 388, width: 900, height: 008, color: 'red',    effect: 'tele', px: 20, py: 370 }); 
//End goal
end.push    ({ x: 000, y: 050, width: 100, height: 100, color: 'blue',   effect: 'win',  px: 20, py: 370 });; 
//Walls
boxes.push  ({ x: 000, y: 110, width: 010, height: 400, color: 'green'  });
boxes.push  ({ x: 000, y: 000, width: 010, height: 085, color: 'green'  });
boxes.push  ({ x: 000, y: 390, width:1000, height: 050, color: 'orange' });
boxes.push  ({ x: 990, y: 000, width: 050, height: 400, color: 'yellow' });
//Platforms
boxes.push  ({ x: 000, y: 350, width: 090, height: 050, color: '#655643' });//Start block
boxes.push  ({ x: 200, y: 325, width: 130, height: 030, color: '#655643' });//First platform
boxes.push  ({ x: 400, y: 350, width: 150, height: 030, color: '#655643' });//Second platform
boxes.push  ({ x: 610, y: 290, width: 090, height: 030, color: '#655643' });//Third block
boxes.push  ({ x: 730, y: 250, width: 100, height: 030, color: 'black'   });//Fourth platform
boxes.push  ({ x: 900, y: 200, width: 050, height: 030, color: 'red'     });//Fifth platform
boxes.push  ({ x: 760, y: 135, width: 065, height: 030, color: 'blue'    });//Sixth platform
boxes.push  ({ x: 680, y: 120, width: 070, height: 030, color: 'blue'    });//Seventh platform
boxes.push  ({ x: 500, y: 200, width: 090, height: 025, color: '#655643' });//Eigth platform
boxes.push  ({ x: 300, y: 180, width: 080, height: 025, color: '#655643' });//Ninth platform
boxes.push  ({ x: 200, y: 160, width: 030, height: 025, color: '#655643' });//Tenth platform
boxes.push  ({ x: 000, y: 130, width: 095, height: 025, color: '#655643' });//Eleventh platform
...
function update() {
   ...
   for(var j = 0; j < lava.length; j++) {
      ...
      if(colCheck(player, lava[j])!==null) { if (lava[j].effect==='tele') { player.x=lava[j].px; player.y=lava[j].py; } } //lava collision
   }
